...
class VideoLibrary:
    ...
    def get_videos_in_ids(self, video_ids):
        videos = [video for video_id, video in self._videos.items() if video_id in video_ids]
        return videos

    def get_videos_not_in_ids(self, video_ids):
        videos = [video for video_id, video in self._videos.items() if video_id not in video_ids]
        return videos
